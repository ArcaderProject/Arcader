...
export const StorageList = ({
    ...
    return (
        <div className="space-y-3">
            {folders.map((folder) => (
                <ContextMenu key={folder.uuid}>
                    <ContextMenu.Trigger asChild>
                        <div
                            onClick={() => !folder.isActive && onActivate(folder)}
                            className={cn(
                                "group relative border-4 p-4 transition-all duration-200",
                                folder.isActive
                    ...
                    <ContextMenu.Content>
                        {!folder.isActive && (
                            <ContextMenu.Item onClick={() => onActivate(folder)}>
